...
export default function NewEstimatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const estimateNumber = `EST-${today.getFullYear().toString().slice(2)}${String(today.getMonth() + 1).padStart(2, "0")}${String(today.getDate()).padStart(2, "0")}-${String(Math.floor(Math.random() * 900) + 100)}`;
    ...
    <section>
      ...
      <form onSubmit={handleSubmit} className="bcs-form">
        ...
        <div className="bcs-form-row">
          <div className="bcs-form-group">
            <label className="bcs-form-label">Estimate Date</label>
            <input
              type="date"
          ...
          <div className="bcs-form-group">
            <label className="bcs-form-label">Valid Until</label>
            <input
              type="date"
              className="bcs-form-input"
        ...
        <button type="submit" className="bcs-btn-primary" disabled={loading} style={{ background: "linear-gradient(135deg, #ff6d00 0%, #e65100 100%)" }}>
